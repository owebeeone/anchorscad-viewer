...
export const MODULES_PANEL_COLLAPSED = defineGrip<boolean>('UI.ModulesPanelCollapsed', false);
export const MODULES_PANEL_COLLAPSED_TAP = defineGrip<AtomTapHandle<boolean>>('UI.ModulesPanelCollapsed.Tap');
